...
// 调试：检查替换后的autoPushCheck
const checkIdx = h.indexOf('function autoPushCheck');
const checkEnd = h.indexOf('function updateAccountUI');
console.log('\n---New autoPushCheck---');
console.log(h.substring(checkIdx, checkEnd));
console.log('---End---\n');

// 检查括号平衡
const code = h.substring(checkIdx, checkEnd);
...
console.log('JS extracted, size:', inline.length);