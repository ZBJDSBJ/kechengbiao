...
// 问题分析：Server酱desp字段用Markdown渲染，单个\n不产生换行
// 解决方案：每行末尾加两个空格（Markdown硬换行），或用\n\n分段
...
const newBuild1 = 'function buildTodaySchedule(){const now=new Date();const day=now.getDay();const dows=["周日","周一","周二","周三","周四","周五","周六"];var L=[];L.push("📚 今日课程");L.push("📅 "+now.getFullYear()+"年"+(now.getMonth()+1)+"月"+now.getDate()+"日 "+dows[day]);L.push("───────────────");const todayKey=now.getFullYear()+"-"+(now.getMonth()+1)+"-"+now.getDate();if(typeof holidays2026!=="undefined"){const hol=holidays2026[todayKey];if(hol&&hol.type==="holiday"){L.push("");L.push("🎉 今天放假 · "+hol.name);L.push("好好休息！");return L.join("  \\n")}}if(day===0||day===6){L.push("");L.push("📅 周末无课程");L.push("好好休息！");return L.join("  \\n")}var hasCourse=false;scheduleData.forEach(function(row){if(row.period==="午休"){L.push("");L.push("🍽️ "+row.period+" "+row.time);return}const sub=row.subjects[day-1];if(sub){hasCourse=true;L.push("");L.push("📖 "+row.period+" "+row.time);L.push(sub.name+(sub.teacher?" · "+sub.teacher:""))}});if(!hasCourse){L.push("");L.push("📅 今天无课程")}return L.join("  \\n")}';
...
const newBuild2 = 'function buildTomorrowSchedule(){const tmr=new Date();tmr.setDate(tmr.getDate()+1);const day=tmr.getDay();const dows=["周日","周一","周二","周三","周四","周五","周六"];var L=[];L.push("📚 明日课程");L.push("📅 "+tmr.getFullYear()+"年"+(tmr.getMonth()+1)+"月"+tmr.getDate()+"日 "+dows[day]);L.push("───────────────");const tmrKey=tmr.getFullYear()+"-"+(tmr.getMonth()+1)+"-"+tmr.getDate();if(typeof holidays2026!=="undefined"){const hol=holidays2026[tmrKey];if(hol&&hol.type==="holiday"){L.push("");L.push("🎉 明天放假 · "+hol.name);L.push("好好休息！");return L.join("  \\n")}}if(day===0||day===6){L.push("");L.push("📅 明天周末无课程");L.push("好好休息！");return L.join("  \\n")}var hasCourse=false;scheduleData.forEach(function(row){if(row.period==="午休"){L.push("");L.push("🍽️ "+row.period+" "+row.time);return}const sub=row.subjects[day-1];if(sub){hasCourse=true;L.push("");L.push("📖 "+row.period+" "+row.time);L.push(sub.name+(sub.teacher?" · "+sub.teacher:""))}});if(!hasCourse){L.push("");L.push("📅 明天无课程")}return L.join("  \\n")}';
